...
INPUT_CSV = Path(r"D:\.Candra\Project\TA\02_data\interim\postureexercise_keypoints\postureexercise_keypoints.csv")
SPLIT_CSV = Path(r"D:\.Candra\Project\TA\03_metadata\final_split\postureexercise.csv")
OUTPUT_DIR = Path(r"D:\.Candra\Project\TA\02_data\processed\postureexercise")
